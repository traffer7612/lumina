...
| Contract | Address |
|----------|---------|
| AuraEngine (implementation) | `0xabb9a8986f2ef5abf136f4902fd35e49e37f088e` |
| AuraProxy (engine) | `0xd2168f8429acb4796465b07ca6ecf192d9b41619` |
| AuraUSD (aUSD) | `0xe1b1a3814c3f5f3cdfd85a63225f7d16ecdd6785` |
| AuraMarketRegistry | `0x070b9c6bdbffabefe02de23840069f15eb821c55` |
| AuraRouter | `0x4f083ab27345f353e61f04988c8fefc76eacbb7d` |
| AuraTreasury | `0xeec09a4ec6fabef4587195296f2d0a4404c7a947` |
| **Legacy PSM (USDC)** | `0xcb18d815e5b686372d9494583812cd46ca869919` |
| AuraToken (LUMINA ticker in UI) | `0xbf6fa2c4d3c31b794417f87d1c06dc401e012e28` |
| VeAura | `0x9617c423dcaaf8d029d4c547747ef020974fcca5` |
| TimelockController | `0x14fae3f4c19a4733ea5762123b8a9131615b2d19` |
| AuraGovernor | `0xa4d0f26cabec345034c2687467b6157cae581216` |
...
| Legacy PSM | `0xcb18d815e5b686372d9494583812cd46ca869919` | Deprecate after liquidity moved and `AuraUSD.removeMinter(legacy)` executed via governance. |

Confirm `AuraUSD.minters(newPSM) == true` on Arbiscan after Timelock executes `addMinter`.
